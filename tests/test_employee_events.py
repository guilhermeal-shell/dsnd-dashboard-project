...
def test_employee_table_exists(table_names):
    ...
    #### YOUR CODE HERE
    assert "employee" in table_names, "Table 'employee' is NOT in the database"
...
def test_team_table_exists(table_names):
    ...
    # is in the table_names list
    #### YOUR CODE HERE
    assert "team" in table_names, "Table 'team' is NOT in the database"
...
def test_employee_events_table_exists(table_names):
    ...
    # is in the table_names list
    #### YOUR CODE HERE
    assert "employee_events" in table_names, "Table 'employee_events' is NOT in the database"
